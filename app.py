...
st.write("Датасет содержит информацию о ведущих языковых моделях: их характеристики, результаты бенчмарков (MMLU, HumanEval, GPQA) и стоимость токенов. у нас 20 пропусков в parameter_count_B и 5 пропусков в gpqa_diamond_score.")
st.write("Заполнение пропусков: умножаем MMLU этих моделей на среднее отношение GPQA к MMLU по всему датасету, parameter_count_B заполним нулями")
